class GridWorld:
    def __init__(self):
        ...
        self.state_store = {
            (0, 0): {
                "actions": {
                    "right": {"p": 0.5, "s'": {(0, 1): {"p": 1, "r": 0}}},
                    "down": {"p": 0.5, "s'": {(1, 0): {"p": 1, "r": 0}}},
                },
                "value": 0,
            },
            (0, 1): {
                "actions": {
                    "left": {"p": 0.5, "s'": {(0, 0): {"p": 1, "r": 0}}},
                    "right": {"p": 0.5, "s'": {(0, 2): {"p": 1, "r": 0}}},
                },
                "value": 0,
            },
            (0, 2): {
                "actions": {
                    "left": {"p": 0.33, "s'": {(0, 1): {"p": 1, "r": 0}}},
                    "right": {"p": 0.33, "s'": {(0, 3): {"p": 1, "r": 1}}},
                    "down": {"p": 0.33, "s'": {(1, 2): {"p": 1, "r": 0}}},
                },
                "value": 0,
            },
            (0, 3): {
            ...
            (1, 0): {
                "actions": {
                    "up": {"p": 0.5, "s'": {(0, 0): {"p": 1, "r": 0}}},
                    "down": {"p": 0.5, "s'": {(2, 0): {"p": 1, "r": 0}}},
                },
                "value": 0,
            },
            (1, 2): {
                "actions": {
                    "up": {"p": 0.33, "s'": {(0, 2): {"p": 1, "r": 0}}},
                    "right": {"p": 0.33, "s'": {(1, 3): {"p": 1, "r": -1}}},
                    "down": {"p": 0.33, "s'": {(2, 2): {"p": 1, "r": 0}}},
                },
                "value": 0,
            },
            ...
            (2, 1): {
                "actions": {
                    "left": {"p": 0.5, "s'": {(2, 0): {"p": 1, "r": 0}}},
                    "right": {"p": 0.5, "s'": {(2, 2): {"p": 1, "r": 0}}},
                },
                "value": 0,
            },
            (2, 2): {
                "actions": {
                    "up": {"p": 0.33, "s'": {(1, 2): {"p": 1, "r": 0}}},
                    "left": {"p": 0.33, "s'": {(2, 1): {"p": 1, "r": 0}}},
                    "right": {"p": 0.33, "s'": {(2, 3): {"p": 1, "r": 0}}},
                },
                "value": 0,
            },
            (2, 3): {
                "actions": {
                    "left": {"p": 0.5, "s'": {(2, 2): {"p": 1, "r": 0}}},
                    "up": {"p": 0.5, "s'": {(1, 3): {"p": 1, "r": -1}}},
                },
                "value": 0,
            },
        }
        ...
        for row in range(3):
            ...
            for col in range(4):
                if (row, col) == (1, 1):
                    ...
                    row_values.append(f"{value:10.3f}")
                else:
                    row_values.append("    ----    ")
